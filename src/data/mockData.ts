...
export const ALUNOS_MOCK: Aluno[] = [
  ...
  },
  {
    ...
    nome: 'Mariana Souza',
    turma: 'Berçário II - Manhã',
    responsaveis: 'Luciana Souza (Mãe)',
    telefoneContato: '(14) 99751-9181',
    presente: true,
    recadinhoIndividual: 'Mariana brincou na cabana sensorial e interagiu carinhosamente com os colegas.'
  }
];
...
export const ROTINAS_MOCK: Record<string, RotinaDia> = {
  ...
  '6': {
    ...
    evacuacao: 'Normal',
    humor: 'Alegre',
    atividades: ['Cabana sensorial', 'Brinquedos de encaixe'],
    recadinhoEducadora: 'Mariana brincou na cabana sensorial e interagiu carinhosamente com os colegas.'
  }
};
