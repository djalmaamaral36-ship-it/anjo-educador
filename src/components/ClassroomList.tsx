...
export default function ClassroomList({ 
    ...
    return (
      <div className="flex flex-col items-center justify-center p-12 text-center bg-white rounded-3xl border border-red-100 shadow-sm space-y-4">
        ...
        <p className="text-sm text-slate-500 max-w-md leading-relaxed">
          Por motivos de segurança e privacidade dos alunos, esta tela é restrita aos educadores e equipe da escola. Você só pode acompanhar as informações do seu próprio filho através do Diário da Infância.
        </p>
      </div>
    );
  }
  ...
  const startCameraDetail = async (facing: 'user' | 'environment' = cameraFacingModeDetail) => {
    ...
    try {
      ...
      console.error("Erro ao acessar a câmera do prontuário:", err);
      setCameraErrorDetail("Não foi possível acessar a câmera do dispositivo. Verifique as permissões de acesso.");
    }
  };
            ...
            <div className="bg-white rounded-3xl border border-slate-200/90 shadow-sm overflow-hidden sticky top-6">
              ...
              {isEditingStudentProfile ? (
                ...
                <div className="pt-1.5 border-t border-slate-100">
                  ...
                  >
                    <Plus className="w-3.5 h-3.5" /> Adicionar Parâmetro / Alerta
                  </button>
                      ...
                      <div className="flex flex-col sm:flex-row items-center gap-4">
                        ...
                        <div className="flex-1 space-y-3 w-full">
                          <div className="flex flex-wrap gap-2">
                            ...
                            >
                              <Camera className="w-3.5 h-3.5 text-indigo-600" /> Tirar Foto na Câmera
                            </button>
