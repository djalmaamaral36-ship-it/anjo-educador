  ...
  if (isHidden) {
    return (
      <button
        ...
        className="fixed top-2 right-2 z-[9999] p-1.5 rounded-full bg-emerald-950/80 border border-emerald-500/50 text-emerald-300 shadow-md backdrop-blur-xs text-[10px] flex items-center gap-1 active:scale-95"
      >
