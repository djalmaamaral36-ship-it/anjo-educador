  ...
  return (
    <header className="w-full shadow-md z-30 sticky top-0">
      ...
      <div className="bg-gradient-to-r from-teal-600 via-indigo-700 to-indigo-800 text-white px-3 sm:px-5 py-2">
        <div className="max-w-[1500px] mx-auto flex items-center justify-between gap-2 sm:gap-3">
            ...
            {primaryNavItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`px-1.5 py-1 xl:px-2.5 xl:py-1.5 rounded-xl text-[10px] xl:text-xs font-bold transition flex items-center gap-1 xl:gap-1.5 cursor-pointer whitespace-nowrap ${
                    isActive
