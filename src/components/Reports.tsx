      ...
      {showPrintReady && (
        <div className="bg-white border-2 border-slate-400 p-8 rounded-3xl space-y-6 shadow-2xl relative watermark-protected">
          ...
          <p className="text-[10px] text-slate-400 text-center italic pt-1">
            {isEscolar ? 'Anjinho Escolar — Onde os primeiros capítulos da infância são guardados com amor.' : 'Anjo Cuidador — Cuidado, presença e tranquilidade para quem você ama.'} Relatório compilado eletronicamente em {new Date().toLocaleDateString('pt-BR')}.
          </p>
        </div>
      )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="p-5 border border-slate-200 rounded-2xl bg-cyan-50/30 space-y-3">
                <h4 className="font-bold text-sky-850 flex items-center gap-1">
                  <Droplets className="text-cyan-500 w-5 h-5" /> Parâmetros de Hidratação
                </h4>
